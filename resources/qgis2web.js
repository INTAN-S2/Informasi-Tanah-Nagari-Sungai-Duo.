...
map.getView().fit([11313468.422800, -116903.582760, 11323449.629773, -111596.153599], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Informasi Nilai Tanah Nagari Sungai Duo</h2>';
        return titleElement;
    })(),
